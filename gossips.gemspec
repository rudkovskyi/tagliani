...
require "gossips/version"

Gem::Specification.new do |spec|
  spec.name          = "gossips"
  spec.version       = Gossips::VERSION
  ...
  spec.homepage      = "https://theoryofe.co/gossips"
  spec.license       = "MIT"

  if spec.respond_to?(:metadata)
    spec.metadata["homepage_uri"] = spec.homepage
    spec.metadata["source_code_uri"] = "https://github.com/rudkovskyi/gossips/"
  else
